...
#define STRING_CONFIG_H_AUTHOR "(Bebbe Bugfix 07.07.2020, Ender-3)" // Who made the changes.
...
#define DEFAULT_bedKp 215.12
#define DEFAULT_bedKi 30.15
#define DEFAULT_bedKd 1023.21
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -40.6, 8.9, 0 }
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define UBL_Z_RAISE_WHEN_OFF_MESH 5.0 // When the nozzle is off the mesh, this value is used
...
//#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_Y_POINT ((X_BED_SIZE) / 3)  // Y point for Z homing when homing all axes (G28).
#endif

// Homing speeds (mm/m)
#define HOMING_FEEDRATE_XY (40*60)   // SPEED IN MM/S * 60 FOR MM/MINUTE
#define HOMING_FEEDRATE_Z  (4*60)    // SPEED IN MM/S * 60 FOR MM/MINUTE 
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { (X_MIN_POS +1), (Y_MIN_POS +230), 5 }
